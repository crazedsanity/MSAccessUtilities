...
Function exportModulesTxt(sADPFilename, sExportpath)
    ...
    For Each myObj In oApplication.CurrentProject.AllForms
        ...
        oApplication.SaveAsText acForm, myObj.fullname, sExportpath & "\Forms\" & myObj.fullname & ".frm.txt"
        oApplication.DoCmd.Close acForm, myObj.fullname
        dctDelete.Add "FO" & myObj.fullname, acForm
    Next
    For Each myObj In oApplication.CurrentProject.AllModules
        WScript.Echo "  " & myObj.fullname
        oApplication.SaveAsText acModule, myObj.fullname, sExportpath & "\Modules\" & myObj.fullname & ".bas.txt"
        dctDelete.Add "MO" & myObj.fullname, acModule
    Next
    For Each myObj In oApplication.CurrentProject.AllMacros
        WScript.Echo "  " & myObj.fullname
        oApplication.SaveAsText acMacro, myObj.fullname, sExportpath & "\Macros\" & myObj.fullname & ".mcr.txt"
        dctDelete.Add "MA" & myObj.fullname, acMacro
    Next
    For Each myObj In oApplication.CurrentProject.AllReports
        WScript.Echo "  " & myObj.fullname
        oApplication.SaveAsText acReport, myObj.fullname, sExportpath & "\Reports\" & myObj.fullname & ".report.txt"
